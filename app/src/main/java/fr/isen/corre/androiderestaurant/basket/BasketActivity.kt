...
import fr.isen.corre.androiderestaurant.EntPlDes
import fr.isen.corre.androiderestaurant.databinding.ActivityBasketBinding
import fr.isen.corre.androiderestaurant.network.NetworkConstants
import fr.isen.corre.androiderestaurant.user.UserActivity
...
class BasketActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //binding.totalPrice.text = getString(Basket.totalPrice.toInt())
        loadList()
